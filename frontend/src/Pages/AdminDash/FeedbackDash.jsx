...
const FeedbackDash = () => {
    ...
    const calculateAverageRating = (rating1, rating2, rating3) => {
    ...
    const newData = post.map((data) => {
        ...
        return {
            ...
            averageRating: calculateAverageRating(data.rating, data.rating2, data.rating3)
        }
    });

    const excelExport = () => {
        exportToExcel(newData, 'FeedbackReport.xlsx');
    }
